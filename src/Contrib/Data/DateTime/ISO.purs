-- module copied and adjusted from http://github.com/jmackie/purescript-datetime-iso
...
--parseISO :: forall s m. Monad m => P.ParserT String m ISO
--parseISO = do
--    date <- parseISODate
--    _ <- PS.char 'T'
--    time <- parseISOTime
...
--
--parseISODate :: forall s m. Monad m => P.ParserT String m Date
--parseISODate = do
...
--
--parseISOTime :: forall s m. Monad m => P.ParserT String m Time
--parseISOTime = do
...
--
--parseDigits :: forall s m. Monad m => Int -> P.ParserT String m Int
--parseDigits = map foldDigits <<< sequence <<< flip Array.replicate parseDigit
--
--parseDigit :: forall s m. Monad m => P.ParserT String m Int
